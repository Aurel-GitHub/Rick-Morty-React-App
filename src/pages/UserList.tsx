...
const UserList: React.FC = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < characterID.length; i++) {
      axios
      .get(
        `https://rickandmortyapi.com/api/character/${characterID && characterID[i]}`
      )
  ...
  return (
      <div className="user-list-page">
              ...
              <div className="result">
                {listData.length > 0 ? ( listData.map((character: any) => <Card character={character} key={character.id + `character`}/>)
